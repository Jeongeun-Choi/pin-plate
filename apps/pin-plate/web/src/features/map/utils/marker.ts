...
export const getPinIcon = (
  ...
  return `<svg width="${width}" height="${height}" viewBox="0 0 100 150" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    ${rating !== undefined ? `<text x="50" y="48" text-anchor="middle" dominant-baseline="middle" font-size="32" font-weight="700" fill="${resolvedRatingTextColor}" font-family="Pretendard, sans-serif">${rating}</text>` : ''}
